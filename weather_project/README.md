...
# -Переходим на сайт weathermap, регистрируемся
...
# Не забываем обработать исключения на случай если города не существует в запросе:
...
# в context добавляем значения form:

# context = {'all_info': all_cities, 'form': form}

# теперь надо вывести значения. Добавляем в index.html параметр: 
# ...
# {% csrf_token %}
# <label for="city">Город</label>
# {{ form.name}}
...
# -заходим в forms, добавляем CityForm() атрибут 
...
# -Теперь если мы введем город он сохраниться в БД, страница перезагрузиться и справа будет отображен новый город
# Конец***********************************************************************************************************